        ...
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    ...
                    <div class="banner-frame"> <img class="img-fluid" src="{{ Storage::url('public/diskons/').$diskon->gambar }}" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">{{ $diskon->judul }}</h2>
                    <p>{{ $diskon->deskripsi }}</p>
                </div>
                @empty
                    <div class="alert alert-danger">
                    Belum ada diskon yang tersedia. Terus Update untuk diskon selanjutnya!!!
                    </div>
                @endforelse
            </div>
