                    ...
                    <form action="{{ route('reservasiku.update', $reservasiku->id) }}" method="post">                            
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="user_id" value="{{ $reservasiku->user_id }}"></br>
                            </div>
                            <div class="form-group">
                                <label for="tanggal">Tanggal</label>
                                <input type="date" class="form-control" readonly name="tanggal" value="{{ $reservasiku->tanggal }}"></br>
                            </div>
                            <div class="form-group">
                                <label for="waktu">Waktu</label>
                                <input type="time" class="form-control" readonly name="waktu" value="{{ $reservasiku->waktu }}"></br>
                            </div>
                            <div class="form-group">
                                <label for="orang">Jumlah Orang</label>
                                <input type="text" class="form-control" readonly name="orang" value="{{ $reservasiku->orang }}"></br>
                            </div>
                            <div class="form-group">
                                <label for="spesial">Request</label>
                                <input type="text" class="form-control" readonly name="spesial" value="{{ $reservasiku->spesial }}"></br>
                            </div>
                            <div class="form-group">
